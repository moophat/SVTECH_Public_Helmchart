...
- Edit values.yaml at /opt/SVTECH_Projects_Container/kubernetes/nms_project/charts/debuger
...
- Start chart alone:
    ```
    helm install debuger /opt/SVTECH_Projects_Container/kubernetes/nms_project/charts/debuger
    ```
