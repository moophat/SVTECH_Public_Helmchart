...
|   +--- deployment.yaml
|   +--- service.yaml
|   +--- _helpers.tpl : define your custom template variable here (example: csv-view.image, csv-view.init.image), and you can create new file .tpl
...
- Start chart alone:
    ```
    helm install csv /opt/SVTECH_Projects_Container/kubernetes/nms_project/charts/csv-view
    ```
